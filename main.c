...
void IR_Init(void){
    ...
    ADC14->CTL0 &= ~0x00000002; // disable during setup
    while(ADC14->CTL0&0x00010000){};
    ADC14->CTL0 = 0x04263790;
    ADC14->CTL1 = 0x0000F030; // TODO verify this
    ADC14->MCTL[0] = 0x00000105; // port 5.0
    ADC14->MCTL[1] = 0x00000104; // port 5.1
    ADC14->MCTL[2] = 0x00000103; // port 5.2
